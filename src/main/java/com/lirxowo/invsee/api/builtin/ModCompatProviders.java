...
public class ModCompatProviders {
    ...
    public static void registerAll() {
        if (MekanismCompat.isLoaded()) {
            com.lirxowo.invsee.api.InvseeAPI.registerItemInfoProvider(new MekanismChemicalProvider());
        }

        if (AE2Compat.isLoaded()) {
            com.lirxowo.invsee.api.InvseeAPI.registerItemInfoProvider(new AE2StorageCellProvider());
        }
    }
