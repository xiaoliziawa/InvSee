...
public class ItemMarkRenderer extends EntityRenderer<ItemMarkEntity> {
    ...
    private static final RenderType LINES_SEE_THROUGH = InvseeRenderTypes.linesSeeThroughType();

    /**
     * Helper class to access protected RenderStateShard members
     */
    private static class InvseeRenderTypes extends RenderType {
        // Dummy constructor - never called
        private InvseeRenderTypes() {
            super("dummy", DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS, 0, false, false, () -> {}, () -> {});
        }

        public static RenderType linesSeeThroughType() {
            return create(
